...
\item The \textit{ShareIT Back End} must be able to able to receive a \textit{Media Item} file along with any associated \textit{Media Item Information} and added to the collection of stored \textit{Media Items}'s
...
\item (S) An access right must be able to expire given an expire date
