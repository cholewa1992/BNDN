...
FR-67-TC-01 \cellcolor{red!65} \\ \hline
FR-68-TC-01&UNT&Test if the new user profile has been stored in the database&Passed \cellcolor{green!65} \\ \hline
FR-68-TC-02&UNT&Given a non-unique username, test if an exception is thrown&Passed \cellcolor{green!65} \\ \hline
FR-68-TC-03&UNT&Given an invalid username, test if an exception is thrown&Passed \cellcolor{green!65} \\ \hline
FR-68-TC-04&UNT&Given an invalid password, test if an exception is thrown&Passed \cellcolor{green!65} \\ \hline
FR-69-TC-01&UNT&Test that new Accounts are automatically given a unique ID&Passed \cellcolor{green!65} \\ \hline
FR-75-TC-01&IT&Given a user, a media item and a stream containing the data of the media item, test if the stream is saved to a file&Passed \cellcolor{green!65} \\ \hline
FR-75-TC-02&UNT&Given a user, a media item and a stream containing the data of the media item, test if the media item and all of its information is added to the database&Passed \cellcolor{green!65} \\ \hline
...
FR-85-TC-01&UNT&Given a User and a request the User has rights to perform, test that the User is given access &Failed\footnote{Went with different solution \label{note2}} \cellcolor{cyan!65} \\ \hline
FR-85-TC-02&UNT&Given a User and a request the User does not have the rights to perform, test that the User is denied access&Failed\footnoteref{note2} \cellcolor{cyan!65} \\ \hline
FR-86-TC-01&UNT&Given a User and a request the User does not have the rights to perform, test that a response describing the problem is sent to the Client&Failed\footnoteref{note2} \cellcolor{cyan!65} \\ \hline
