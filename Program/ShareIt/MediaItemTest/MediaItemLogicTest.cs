...
namespace MediaItemTest
{
    ...
    {
        private readonly MediaItemLogic _mediaItemLogic = new MediaItemLogic(IStorageBridge);
        ...
        public void Initialize()
        {
            ...
            var mediaItemList = new List<MediaItemInformation>();
            mediaItemList.Add(info1);
            mediaItemList.Add(info2);

            MediaItem _mediaItem = new MediaItem()
            {
                FileExtension = ".jpg",
                Id = 1,
                Information = mediaItemList,
