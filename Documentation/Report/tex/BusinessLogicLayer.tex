%Remember to update the class diagram - at the moment we use BusinessLogicFacade instead of BusinessLogicEntryFactory. The solid arrow from service layer to businesslogicfacade should be dotted.
